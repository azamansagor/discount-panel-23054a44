          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Badge shape */}
                <path d="M50 5L65 15L80 15L85 30L95 45L90 60L95 75L80 85L65 95L50 90L35 95L20 85L5 75L10 60L5 45L15 30L20 15L35 15L50 5Z" fill="white" stroke="#E5E7EB" strokeWidth="2"/>
                {/* Key icon */}
